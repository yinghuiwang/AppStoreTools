...
| --- | --- | --- | --- |
| 6.9" | 1320×2868, 1290×2796, **1260×2736** | `APP_IPHONE_67` | yes |
| 6.5" | 1284×2778, 1242×2688 | `APP_IPHONE_65` | yes |
| 6.3" | 1179×2556, **1206×2622** | `APP_IPHONE_61` | yes |
| 6.1" | 1170×2532, 1125×2436, **1080×2340** | `APP_IPHONE_61` / `APP_IPHONE_58` | 1080×2340 → `APP_IPHONE_61` |
...
| 11" | 1668×2388, plus 1488×2266 / 1668×2420 / 1640×2360 | `APP_IPAD_PRO_3GEN_11` | yes |
...
- Unmapped sizes **fail the upload** (they are no longer silently dropped). Do not tell the user “Apple rejects this size” if it is on the official spec but missing from `constants.py`.
